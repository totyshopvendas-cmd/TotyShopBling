...
import { LayoutDashboard, Package, RefreshCw, Plug, LogOut, Calculator, Download, CheckSquare, Sparkles, ShoppingBag } from "lucide-react";
    ...
    <div className="min-h-screen bg-white flex">
      ...
      <aside className="w-60 border-r border-[#E5E5E5] bg-white flex flex-col" data-testid="app-sidebar">
        ...
        <nav className="flex-1 py-4 flex flex-col gap-0.5">
          ...
          <NavItem to="/products" icon={ShoppingBag} testId="sidebar-nav-my-products">
            Meus Produtos
          </NavItem>
          <NavItem to="/bling-catalog" icon={Sparkles} testId="sidebar-nav-bling">
            Catálogo Bling
          </NavItem>
